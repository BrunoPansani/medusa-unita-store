  ...
  return (
    <>
      ...
      >
        ...
        {isHovered && (
          <div className="fixed left-0 right-0 top-[60px] flex gap-32 py-10 px-20 border-b" style={{ backgroundColor: "var(--color-warm-bg)", borderColor: "var(--color-warm-border)" }}>
