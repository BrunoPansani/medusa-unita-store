          ...
          <TooltipProvider>
            <div className="flex flex-col gap-y-2">
              <Text className="flex items-center gap-x-2 font-medium text-neutral-950">
                ...
                <Tooltip content="Esta configuração determina se os pedidos requerem aprovação do administrador antes de serem processados. Se habilitado, os pedidos serão mantidos até que um administrador os aprove.">
            ...
            <div className="flex flex-col gap-y-2">
              <Text className="flex items-center gap-x-2 font-medium text-neutral-950">
                ...
                <Tooltip content="Esta configuração determina se os pedidos requerem aprovação do gerente de vendas antes de serem processados. Se habilitado, os pedidos serão mantidos até que um gerente de vendas os aprove.">
                  <InformationCircleSolid className="w-4 h-4" />
                </Tooltip>
              </Text>
              <div className="flex items-center gap-x-2 h-3">
