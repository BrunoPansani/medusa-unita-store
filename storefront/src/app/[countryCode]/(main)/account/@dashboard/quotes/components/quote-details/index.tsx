            ...
            <Container className="p-0">
              <div className="flex items-center justify-between px-6 py-4">
                <Text className="txt-compact-small">
                  ...
                  Orçamento aceito pelo cliente. Pedido pronto para processamento.
                </Text>
          ...
          {quote.status === "pending_customer" && (
            <div className="flex gap-x-3 justify-end my-4">
              <PromptModal
                ...
                description="Tem certeza que deseja rejeitar o orçamento? Esta ação é irreversível."
                handleAction={() => {
                  setIsRejecting(true)
              ...
              <PromptModal
                ...
                description="Tem certeza que deseja aceitar o orçamento? Esta ação é irreversível."
                handleAction={() => {
                  setIsAccepting(true)
        ...
        <div className="col-span-2 flex flex-col gap-y-2">
          <Container className="flex gap-x-3 justify-between">
            <div className="text-sm">
              <span className="font-semibold text-ui-fg-subtle">ID do Orçamento:</span>{" "}
